...
Releases are now tagged in Git. I use the version numbers to pin builds of my https://hub.docker.com/r/kieranpotts/docker-devenv[devenv] container to a specific point in this repository's history.
